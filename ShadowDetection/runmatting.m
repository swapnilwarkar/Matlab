function [shadow_free] = runmatting(testfnlist)
...
for i =1:numel(testfnlist)  
    ...
    disp 'Step 5 : Average Smoothing Filtering'
    %Average Smoothing Filtering Done here.
    ...
    %figure(4), imshow(shadow_free); title('Shadow Free IMAGE');
end
